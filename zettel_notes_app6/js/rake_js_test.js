...
// let string = "  исторический     материализм    ";
// string = string.replace(/\s+/g, " ");
// console.log(string);


const strings = ["  исторический    материализм  ",
                " общественное    развитие  "];
const moreStrings = [' учение Маркса вечно,  ',
                    ' потому что верно']                
...
const result2 = moreStrings.map(str => str.replace(/\s+/g, " "));
const finals = result.concat(result2);
console.log(finals);
